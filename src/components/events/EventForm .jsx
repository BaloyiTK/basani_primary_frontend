...
<form onSubmit={handleSubmit} className="shadow-md rounded px-8 pt-6 pb-8 mb-4 max-w-md mx-auto">
  <div className="mb-4">
    ...
    <input
      ...
      required
      className="appearance-none bg-white border border-gray-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
    />
  </div>
  <div className="mb-4">
